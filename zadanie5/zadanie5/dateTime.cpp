...
DateTime :: DateTime(void):	
							Date(),
							hour(Date::timeinfo->tm_hour),
							minute(Date::timeinfo->tm_min),
							second(Date::timeinfo->tm_sec)
{
	//cout << Date::timeinfo->tm_sec << endl;						
}
...
ostream & operator << (ostream &output, EventPair &e)
{
